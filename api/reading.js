...
function buildPrompt(words) {
  ...
  return [
    ...
    '- VARIETY IS ESSENTIAL — every story must feel distinctly different from a "default" story.',
    '  Rotate character types freely: child, elderly person, teenager, chef, scientist, athlete,',
    '  artist, immigrant, teacher, traveller, engineer, musician, fisherman, nurse, astronaut…',
    '  Rotate settings freely: mountain village, submarine, night market, 1920s city, hospital,',
    '  space station, countryside farm, rooftop garden, desert oasis, snowy forest, small café…',
    '  Rotate genre/mood freely: mystery, gentle comedy, suspense, heartwarming, adventure,',
    '  coming-of-age, unexpected friendship, sci-fi, historical, bittersweet, slice-of-life…',
    '  Never default to the same character-type + setting + mood combination you might use routinely.',
